...
function findHospitals() {
  showToast("📍 Finding nearby hospitals...");
  ...
  if ("geolocation" in navigator) {
    navigator.geolocation.getCurrentPosition(
      function(position) {
        ...
        window.open(`https://www.google.com/maps/search/hospitals+near+me/@${lat},${lng},15z`, '_blank');
      },
      function(error) {
        alert("Please enable location access");
        window.open('https://www.google.com/maps/search/hospitals+in+Mangalore', '_blank');
      },
  ...
  if ("geolocation" in navigator) {
    navigator.geolocation.getCurrentPosition(
      function(position) {
        ...
        // Real Mangalore Hospitals
        var hospitalsList = [
          { name: "A.J. Hospital & Research Centre", address: "Kuntikana, Mangaluru", lat: 12.8988, lng: 74.8436, url: "https://www.google.com/maps/place/A.J.+Hospital+%26+Research+Centre/@12.919098,74.829742,3395m/data=!3m1!1e3!4m10!1m2!2m1!1shospitals+near+me!3m6!1s0x3ba35a682d20b7bb:0x56352072513aae09!8m2!3d12.8993521!4d74.8460278!15sChFob3NwaXRhbHMgbmVhciBtZSIDkAEBWhMiEWhvc3BpdGFscyBuZWFyIG1lkgEQZ2VuZXJhbF9ob3NwaXRhbOABAA!16s%2Fg%2F11bw2fk8gr?entry=ttu&g_ep=EgoyMDI2MDQyMi4wIKXMDSoASAFQAw%3D%3D" },
          { name: "Yenepoya Medical College Hospital", address: "Deralakatte, Mangaluru", lat: 12.8091, lng: 74.8808, url: "https://www.google.com/maps/place/Yenepoya+University+Medical+College+Hospital/@12.8127251,74.8782673,524m/data=!3m1!1e3!4m9!1m2!2m1!1shospitals+near+me!3m5!1s0x3ba35eaf4f98d5e9:0x38d460a61774563b!8m2!3d12.8131275!4d74.8811945!16s%2Fg%2F11h13n79k?entry=ttu&g_ep=EgoyMDI2MDQyMi4wIKXMDSoASAFQAw%3D%3D" },
          { name: "KMC Hospital", address: "Dr B R Ambedkar Circle, Mangaluru", lat: 12.8711, lng: 74.8427, url: "https://www.google.com/maps/place/KMC+Hospital+Mangaluru/@12.87197,74.8354746,3396m/data=!3m1!1e3!4m10!1m2!2m1!1shospitals+near+me!3m6!1s0x3ba35a4993ec4925:0xf7e8eff2463b0352!8m2!3d12.8719806!4d74.8488363!15sChFob3NwaXRhbHMgbmVhciBtZSIDkAEBWhMiEWhvc3BpdGFscyBuZWFyIG1lkgEQcHJpdmF0ZV9ob3NwaXRhbOABAA!16s%2Fg%2F11g87cbgs4?entry=ttu&g_ep=EgoyMDI2MDQyMi4wIKXMDSoASAFQAw%3D%3D" }
        ];

        // Calculate distances and sort
        hospitalsList.forEach(function(h) {
          h.distance = parseFloat(getDistanceFromLatLonInKm(lat, lng, h.lat, h.lng));
        });
        hospitalsList.sort(function(a, b) { return a.distance - b.distance; });

        let hospitalsHTML = '';
        hospitalsList.forEach(function(h, index) {
          let nearestBadge = index === 0 ? '<span style="display: block; color: #2ecc71; font-size: 0.75rem;">Nearest</span>' : '';
          let bg = index === 0 ? 'rgba(46, 204, 113, 0.1)' : 'rgba(255, 255, 255, 0.05)';
          let border = index === 0 ? 'rgba(46, 204, 113, 0.3)' : 'rgba(255, 255, 255, 0.1)';
          let nameColor = index === 0 ? '#2ecc71' : '#fff';
          
          hospitalsHTML += `
            <a href="${h.url}" target="_blank" style="display: flex; justify-content: space-between; align-items: center; padding: 0.75rem; background: ${bg}; border: 1px solid ${border}; border-radius: 8px; margin-bottom: 0.5rem; text-decoration: none; cursor: pointer; transition: transform 0.2s;" onmouseover="this.style.transform='scale(1.02)'" onmouseout="this.style.transform='scale(1)'">
              <div>
                <strong style="color: ${nameColor}; display: block; font-size: 0.95rem;">${h.name}</strong>
                <span style="color: #94a3b8; font-size: 0.8rem;">${h.address}</span>
              </div>
              <div style="text-align: right; min-width: 60px;">
                <strong style="color: #fff;">${h.distance} km</strong>
                ${nearestBadge}
              </div>
            </a>
          `;
        ...
        hospitalDiv.innerHTML = `
          ...
          <a href="https://www.google.com/maps/search/hospitals+near+me/@${lat},${lng},15z" target="_blank" style="display: flex; align-items: center; justify-content: center; gap: 0.5rem; width: 100%; padding: 0.9rem; background: rgba(59, 130, 246, 0.15); border: 1px solid rgba(59, 130, 246, 0.4); border-radius: 10px; color: #60a5fa; text-decoration: none; font-weight: 600; transition: background 0.2s;" onmouseover="this.style.background='rgba(59, 130, 246, 0.25)'" onmouseout="this.style.background='rgba(59, 130, 246, 0.15)'">
      ...
      function(error) {
        hospitalDiv.innerHTML = `
          <div style="display: flex; align-items: center; gap: 0.75rem; color: var(--accent-red, #ff3b3b);">
            ...
            <strong>Please enable location access to find nearby hospitals</strong>
          </div>
        `;
      },
      { enableHighAccuracy: true, timeout: 10000, maximumAge: 0 }
